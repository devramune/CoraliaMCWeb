...
import sty from "./PlasmicCoraliaPlus.module.css"; // plasmic-import: VDGf5byMaq6/css
...
export type PlasmicCoraliaPlus__VariantMembers = {};

export type PlasmicCoraliaPlus__VariantsArgs = {};
type VariantPropType = keyof PlasmicCoraliaPlus__VariantsArgs;
export const PlasmicCoraliaPlus__VariantProps = new Array<VariantPropType>();

export type PlasmicCoraliaPlus__ArgsType = {};
type ArgPropType = keyof PlasmicCoraliaPlus__ArgsType;
export const PlasmicCoraliaPlus__ArgProps = new Array<ArgPropType>();

export type PlasmicCoraliaPlus__OverridesType = {
  root?: p.Flex<"div">;
...
export interface DefaultCoraliaPlusProps {}

function PlasmicCoraliaPlus__RenderFunc(props: {
  variants: PlasmicCoraliaPlus__VariantsArgs;
  args: PlasmicCoraliaPlus__ArgsType;
  overrides: PlasmicCoraliaPlus__OverridesType;
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"CoraliaPlus"}</title>

        <meta key="og:title" property="og:title" content={"CoraliaPlus"} />
          ...
          <section className={classNames(projectcss.all, sty.section__xGy8F)}>
            ...
            >
              ...
              >
                ...
                >
                  {
                    "Coralia+ automatically integrates all recommended mods into one easy install."
                  }
                </div>
              </p.Stack>
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCoraliaPlus__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicCoraliaPlus__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicCoraliaPlus__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCoraliaPlus__ArgProps,
          internalVariantPropNames: PlasmicCoraliaPlus__VariantProps
        }),
      [props, nodeName]
    );

    return PlasmicCoraliaPlus__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCoraliaPlus";
  } else {
    func.displayName = `PlasmicCoraliaPlus.${nodeName}`;
  }
  return func;
}

export const PlasmicCoraliaPlus = Object.assign(
  // Top-level PlasmicCoraliaPlus renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCoraliaPlus
    internalVariantProps: PlasmicCoraliaPlus__VariantProps,
    internalArgProps: PlasmicCoraliaPlus__ArgProps
  }
);

export default PlasmicCoraliaPlus;
/* prettier-ignore-end */
